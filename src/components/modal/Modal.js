...
export default function Modal({ isOpen, closeModal, slug }) {
  ...
  const { data, loading, error } = useFetch(`${Api}/${slug}/`);
                      ...
                      <div className="flex-shrink-0 flex items-center justify-center h-auto cursor-pointer">
                        ...
                        >
                          ...
                          <Link to={"/product/" + data.slug}>
                            <img
                              className=" w-full h-auto object-cover md:w-[420px] md:h-[420px] "
